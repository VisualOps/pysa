...
<li><a>section description</a></li>
<li><a>section format</a></li>
<li><a>section action keys</a></li>
</ul></li>
...
<p><strong>pysa</strong> was born from the simple idea that today, while the “cloud revolution” is in progress, it is still hard to keep track of the actual configuration of our machines and easily replicate it on another machine.</p>
...
<p>See <strong>RESOURCES_</strong> section for complete list of managed resources.</p>
<p><strong>pysa</strong> is able to generates the configuration in puppet format (see <em><a href="http://docs.puppetlabs.com/references/latest/type.html">Puppet</a></em> documentation).</p>
<h1>OPTIONS</h1>
<h2>Options list</h2>
<h3>-h, –help</h3>
<p>Display the short help.</p>
<h3>-p, –puppet</h3>
<p>Generates <em>Puppet</em> output.</p>
<h3>-q, –quiet</h3>
...
<p>Specify a filter configuration file. See <strong>FILTERS_</strong> section for more details.</p>
<h1>RESOURCES</h1>
<p>This section describes all the resources scanned by <strong>pysa</strong></p>
<p>By default, all item described are scanned. However, you can apply some filters to avoid or specify some. See the <strong>FILTERS_</strong> section.</p>
<p>At the current state, the resources objects and keys are similar to <em>Puppet</em> types.</p>
<p>Please see <strong>AUTOCONF TOOLS MODULES_</strong> section to be sure to be able to handle all scanned resources.</p>
<h2>configuration files - file</h2>
<p><strong>pysa</strong> scans (and stores in output module) all files located in a specific location. Default <strong>/etc</strong></p>
...
<p>Please see <strong>NOTES_</strong> section.</p>
<p>Primary key: <em>name</em></p>
<h2>hosts - host</h2>
...
<p>Primary key: <em>name</em></p>
<h2>ssh keys - key</h2>
<p><strong>pysa</strong> scans and reproduces root SSH keys (default <em>/root/.ssh</em>). The scan must be done by root to assure this feature.</p>
...
<p>to install a <em>Puppet</em> module: puppet module install <em>module-name</em></p>
<h1>FILTERS</h1>
...
<dl>
<dt>_replaceall:</dt>
<dd><p>true/false REQUIRED Select the filtering mode (replace all except -true- or replace none except -false-) default: true _except: primary_keys_values</p>
</dd>
</dl>
...
<dl>
<dt>_update:</dt>
<dd><p>true/false REQUIRED Select the filtering mode (update all except -true- or update none except -false-) default: false</p>
</dd>
</dl>
...
document.write('<a h'+'ref'+'="ma'+'ilto'+':'+e+'">'+e+'<\/'+'a'+'>');
// -->
</script><noscript>&#112;&#x79;&#x73;&#x61;&#32;&#x61;&#116;&#32;&#x6d;&#x63;&#50;&#32;&#100;&#x6f;&#116;&#32;&#x69;&#x6f;</noscript>&gt;</p>
<p>If you have a question about a specific source file, you can also contact the author directly (see the <strong>AUTHOR_</strong> section)</p>
<h1>SEE ALSO</h1>
